...
class BuildPet(QMainWindow):
    ...
    def set_icon_book(self, id):
        ...
        elif id == 'Tigre Dourado do Ano Novo':
            self.prefab_book_main(layout_book_order[0],14, 7)
            self.prefab_book_super(layout_book_order[1],7, 7)
            self.prefab_book_mega(layout_book_order[2],8, 7)
    ...
    def prefab_book_main(self, ref_layout_book, quantity,index=0):
        ...
        if index == 8:
            ...
            label_description_book_main[1].setText('Despertar Bestial Intermediário')
            label_description_book_main[2].setText('Despertar Bestial Avançado')

            label_description_book_main[3].setText('Força Bruta')
            label_description_book_main[4].setText('Força Bruta Intermediário')
            label_description_book_main[5].setText('Força Bruta Avançado')

            label_description_book_main[6].setText('Velocidade do Leopardo')
            label_description_book_main[7].setText('Velocidade do Leopardo Intermediário')
            label_description_book_main[8].setText('Velocidade do Leopardo Avançado')

            label_description_book_main[9].setText('Concentração Espiritual')
            label_description_book_main[10].setText('Concentração Espiritual Intermediário')
            label_description_book_main[11].setText('Concentração Espiritual Avançado')

            label_description_book_main[12].setText('Motivação - Sangue Quente')
            label_description_book_main[13].setText('Instinto Bestial')
